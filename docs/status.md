...
> Snapshot date: 2026-08-22 · branch `feat/project-docs-hld-lld` · one active change, `electric-design-system`; every earlier OpenSpec change is archived and its deltas synced into the canonical specs.
...
| Tests                     | 26 Vitest suites (163 tests) plus lint, token, type, HTML, packaging, installed-smoke, and strict OpenSpec gates                                                                                                                                                                                                                                                                                                                                     |
