...
.tabs .tabpanel { padding: var(--space-4) 0 0; }
...
/* Record HTML is injected a level below .content, so its top-level blocks fall
   outside that grid and would stack flush; this restores the same rhythm. */
.spec-detail-region > [data-spec-detail-content] { display: grid; gap: var(--space-5); align-content: start; }
.spec-detail-region > [data-spec-detail-content] > * { min-width: 0; }
